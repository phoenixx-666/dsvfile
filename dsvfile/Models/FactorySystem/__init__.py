...
class FactorySystem(Model):
    ...
    minerPool = ArrayField(ModelField(MinerComponent), length_field='minerCursor', length_func=decr())
    ...
    inserterPool = ArrayField(ModelField(InserterComponent), length_field='inserterCursor', length_func=decr())
    ...
    assemblerPool = ArrayField(ModelField(AssemblerComponent), length_field='assemblerCursor', length_func=decr())
    ...
    fractionatePool = ArrayField(ModelField(FractionateComponent), length_field='fractionateCursor', length_func=decr())
    ...
    ejectorPool = ArrayField(ModelField(EjectorComponent), length_field='ejectorCursor', length_func=decr())
    ...
    siloPool = ArrayField(ModelField(SiloComponent), length_field='siloCursor', length_func=decr())
    ...
    labPool = ArrayField(ModelField(LabComponent), length_field='labCursor', length_func=decr())
