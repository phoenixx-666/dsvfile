...
class FactoryStorage(Reader):
    ...
    storagePool = ArrayField(lambda: ReaderField(StorageSwitch), length_field='storageCursor', length_function=decr())
    ...
    tankPool = ArrayField(lambda: ReaderField(TankComponent), length_field='tankCursor', length_function=decr())
